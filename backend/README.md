...
* The routes can be added in [NewsampleRoute](./src/main/scala/org/tmt/newsample/http/NewsampleRoute.scala).
...
* The API implementation can be added in [NewsampleImpl](./src/main/scala/org/tmt/newsample/core/NewsampleImpl.scala).
...
can be added as shown in [JNewsampleImpl](./src/main/java/org/tmt/newsample/core/JNewsampleImpl.java). In this case, a Scala
is required, as shown in [JNewsampleImplWrapper](./src/main/scala/org/tmt/newsample/http/JNewsampleImplWrapper.scala)

* Core models for supporting the APIs should be added in the [models](./src/main/scala/org/tmt/newsample/core/models) package.
Codecs for these models should be added in [HttpCodecs](./src/main/scala/org/tmt/newsample/http/HttpCodecs.scala).

* [NewsampleWiring](./src/main/scala/org/tmt/newsample/NewsampleWiring.scala) is where the implementation wired up with the routes.

* [NewsampleApp](./src/main/scala/org/tmt/newsample/NewsampleApp.scala) is the main runnable application. The command line arguments 
for starting the app are defined in [NewsampleAppCommand](./src/main/scala/org/tmt/newsample/NewsampleAppCommand.scala). Any new command  
...
```
* The newly added command/options need to handled in NewsampleApp
